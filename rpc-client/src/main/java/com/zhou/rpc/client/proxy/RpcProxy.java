package com.zhou.rpc.client.proxy;

import com.zhou.rpc.client.discovery.ServiceDiscovery;
import com.zhou.rpc.client.netty.RpcClient;
...
public class RpcProxy {
     ...
     * 只是获取其方法的名字，然后将其封装在netty请求中，发送到netty服务端中请求远程调用的结果
     *
